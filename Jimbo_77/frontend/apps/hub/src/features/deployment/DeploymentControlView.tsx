  ...
  const handleDeploy = (repo: string) => {
    ...
    setTimeout(() => {
      setDeploymentLog(prev =>
        prev.map(action =>
          action.id === newAction.id ? { ...action, status: "completed" as const } : action
        )
      );
    }, 3000);
  };
    ...
    <div className="space-y-8 animate-fade-in text-gray-200">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-glass-border">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <span className="text-4xl text-jimbo-gold drop-shadow-[0_0_10px_rgba(245,158,11,0.5)]">
              🚀
            </span>
          ...
          <p className="font-mono text-sm text-gray-400 tracking-wide mt-2">
            MANAGE DEPLOYMENTS • <span className="text-white font-bold">{repositories.length}</span>{" "}
            REPOSITORIES • GITHUB ACTIONS INTEGRATED
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() =>
              window.open("https://github.com/Bonzokoles/JIMBO_devz_inc_HUB/actions", "_blank")
            }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="glass-panel p-6 rounded-xl border-t-2 border-t-blue-500 relative overflow-hidden group">
          <div className="absolute -right-4 -top-4 text-8xl text-blue-500/5 group-hover:text-blue-500/10 transition-colors">
            ⚡
          </div>
          <div className="text-xs font-bold tracking-widest text-gray-400 mb-2 uppercase">
            Active Repos
          </div>
          <div className="text-5xl font-display text-white drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]">
            8
          </div>
        ...
        <div className="glass-panel p-6 rounded-xl border-t-2 border-t-green-500 relative overflow-hidden group">
          <div className="absolute -right-4 -top-4 text-8xl text-green-500/5 group-hover:text-green-500/10 transition-colors">
            📈
          </div>
          <div className="text-xs font-bold tracking-widest text-gray-400 mb-2 uppercase">
            Success Rate
          </div>
          <div className="text-5xl font-display text-white drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]">
            94.2<span className="text-3xl opacity-70">%</span>
          </div>
        ...
        <div className="glass-panel p-6 rounded-xl border-t-2 border-t-purple-500 relative overflow-hidden group">
          <div className="absolute -right-4 -top-4 text-8xl text-purple-500/5 group-hover:text-purple-500/10 transition-colors">
            ⏱️
          </div>
          <div className="text-xs font-bold tracking-widest text-gray-400 mb-2 uppercase">
            Avg Deploy Time
          </div>
          <div className="text-5xl font-display text-white drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]">
            2<span className="text-3xl opacity-70">m</span> 52
            <span className="text-3xl opacity-70">s</span>
          </div>
        ...
        <div className="glass-panel p-6 rounded-xl border-t-2 border-t-jimbo-gold relative overflow-hidden group animate-pulse-glow">
          <div className="absolute -right-4 -top-4 text-8xl text-jimbo-gold/5 group-hover:text-jimbo-gold/10 transition-colors">
            ⚙️
          </div>
          <div className="text-xs font-bold tracking-widest text-gray-400 mb-2 uppercase">
            Active Workflows
          </div>
          <div className="text-5xl font-display text-jimbo-gold drop-shadow-[0_0_10px_rgba(245,158,11,0.5)]">
            1
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-white/5 bg-black/20">
                  <th className="p-4 pl-6 text-xs text-gray-400 font-bold tracking-wider uppercase">
                    Repository
                  </th>
                  <th className="p-4 text-xs text-gray-400 font-bold tracking-wider uppercase">
                    Status
                  </th>
                  <th className="p-4 text-xs text-gray-400 font-bold tracking-wider uppercase">
                    Last Deploy
                  </th>
                  <th className="p-4 pr-6 text-right text-xs text-gray-400 font-bold tracking-wider uppercase">
                    Actions
                  </th>
                </tr>
              </thead>
                ...
                {repositories.map(repo => (
                  ...
                  >
                    <td className="p-4 pl-6">
                      <div className="font-mono font-bold text-gray-200 group-hover:text-white transition-colors">
                        {repo.name}
                      </div>
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        <span className="text-lg drop-shadow-md filter">
              ...
              deploymentLog.map(action => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center text-[10px] text-gray-500 font-mono border-t border-white/5 pt-2 mt-2">
                    ...
                    <span>
                      by <span className="text-gray-400">{action.user}</span>
                    </span>
                  </div>
                </div>
              ))
          ...
          >
            ...
            <div className="p-8">
              <p className="text-gray-400 text-sm mb-6 flex items-center gap-2">
                <span className="text-lg">🔐</span> Manage GitHub Actions secrets and environment
                variables securely.
              </p>
              ...
              <div className="space-y-2 mb-8">
                ...
                {[
                  ...
                  >
                    <div>
                      <div className="font-mono text-sm font-bold text-gray-200 group-hover:text-jimbo-gold transition-colors">
                        {secret.name}
                      </div>
