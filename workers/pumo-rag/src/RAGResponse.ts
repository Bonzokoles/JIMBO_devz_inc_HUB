        ...
        "https://openrouter.ai/api/v1/chat/completions",
        {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "system",
                content: "Jesteś pomocnym asystentem sklepu meblowego PUMO Guide. " +
              ...
              {
                role: "user",
                content: `Kontekst z bazy produktów PUMO:\n\n${contextText}\n\n` +
      ...
      const workersAIResponse = await env.AI.run(
        "@cf/meta/llama-3.3-70b-instruct-fp8-fast",
        {
          messages: [
            {
              role: "system",
              content: "Jesteś asystentem sklepu PUMO. Odpowiadaj po polsku, profesjonalnie i konkretnie.",
            },
            {
              role: "user",
              content: `Produkty:\n${contextText}\n\nPytanie: ${query}`,
